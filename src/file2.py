...
with mlflow.start_run():  #experiment_id=346799096807584807
    ...
    #log the model
    #mlflow.sklearn.log_model(rf,"Rondom-Forest-Model")
    import joblib
    joblib.dump(rf, "rf_model.pkl")
    mlflow.log_artifact("rf_model.pkl")  # since compatibility issue with log model so directly log this as artifact
